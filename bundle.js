...
// Module
exports.push([module.i, ".header {\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid rgba(0, 0, 0, 0.1); }\n\n.fx-icon {\n  order: -1;\n  width: 24px;\n  height: 24px;\n  opacity: 0.3;\n  transition: .3s linear opacity; }\n\n.fx-input {\n  display: block;\n  flex-grow: 1;\n  margin: 0 5px;\n  line-height: 2;\n  font-size: 16px;\n  border: none;\n  outline: none; }\n  .fx-input:focus + .fx-icon {\n    opacity: 0.6; }\n\n.grid {\n  --cell-width: 100px;\n  --cell-height: 35px;\n  --th-height: 30px;\n  --number-width: 30px;\n  --font-size: 12px;\n  --error: #e74c3c;\n  --columns: 26;\n  --coll-template: 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px 100px;\n  display: grid;\n  outline: none;\n  flex-grow: 1;\n  overflow: auto;\n  max-width: 100%;\n  max-height: 100%;\n  grid-template-areas: \"corner columns\" \"numbers cells\";\n  grid-template-columns: var(--number-width) auto;\n  grid-template-rows: auto;\n  align-content: start;\n  position: relative; }\n  .grid.no-select {\n    user-select: none; }\n  .grid .tl-corner {\n    grid-area: corner;\n    display: block;\n    width: var(----number-width);\n    height: var(--th-height);\n    border-bottom: 1px solid #ccc;\n    border-right: 1px solid #ccc;\n    position: sticky;\n    z-index: 3;\n    top: 0;\n    left: 0; }\n  .grid .columns,\n  .grid .numbers {\n    font-size: var(--font-size); }\n  .grid .tl-corner,\n  .grid .columns,\n  .grid .coll,\n  .grid .numbers,\n  .grid .number,\n  .grid .cell {\n    box-sizing: border-box; }\n  .grid .tl-corner,\n  .grid .columns,\n  .grid .numbers {\n    background-color: #f8f8f8;\n    color: #444; }\n  .grid .columns {\n    grid-area: columns;\n    display: grid;\n    grid-template-columns: var(--coll-template);\n    height: var(--th-height);\n    border-bottom: 1px solid #ccc;\n    white-space: nowrap;\n    position: sticky;\n    z-index: 2;\n    top: 0; }\n  .grid .coll,\n  .grid .number {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    background-color: rgba(0, 0, 0, 0); }\n    .grid .coll.hovered,\n    .grid .number.hovered {\n      background-color: rgba(0, 0, 0, 0.07); }\n  .grid .coll {\n    width: 100%;\n    height: 100%;\n    border-right: 1px solid #ccc; }\n  .grid .coll-content {\n    flex-grow: 1;\n    text-align: center; }\n  .grid .coll-resize-marker {\n    height: 100%;\n    width: 4px;\n    background-color: transparent;\n    cursor: e-resize; }\n    .grid .coll-resize-marker:hover {\n      background-color: #3498db; }\n  .grid .numbers {\n    border-right: 1px solid #ccc;\n    grid-area: numbers;\n    width: var(--number-width);\n    text-align: center;\n    position: sticky;\n    left: 0; }\n  .grid .number {\n    width: var(--number-width);\n    height: var(--cell-height);\n    border-bottom: 1px solid #ccc; }\n  .grid .cells {\n    grid-area: cells;\n    display: grid;\n    max-width: 100%;\n    max-height: 100%;\n    grid-template-columns: var(--coll-template); }\n  .grid .cell {\n    width: 100%;\n    height: var(--cell-height);\n    border-bottom: 1px solid #ccc;\n    border-right: 1px solid #ccc;\n    box-sizing: border-box;\n    transition-duration: .1s;\n    transition-timing-function: linear;\n    transition-property: box-shadow, background-color;\n    white-space: pre;\n    padding: 5px;\n    line-height: 1.5;\n    outline: none;\n    overflow: auto; }\n    .grid .cell.focused {\n      position: relative; }\n      .grid .cell.focused::after {\n        content: '';\n        position: absolute;\n        top: 0;\n        left: 0;\n        right: 0;\n        bottom: 0;\n        display: block;\n        border: 2px solid #3498db;\n        pointer-events: none; }\n    .grid .cell.error {\n      box-shadow: 0 0 0 1px var(--error);\n      border: 1px solid var(--error); }\n  .grid .vertical-resize-marker {\n    position: absolute;\n    left: 0;\n    top: 0;\n    bottom: 0;\n    width: 1px;\n    background-color: #3498db;\n    z-index: 2; }\n\nhtml {\n  font-family: Roboto, Helvetica, sans-serif;\n  font-size: 14px;\n  color: #333; }\n\nhtml, body {\n  height: 100%;\n  margin: 0;\n  padding: 0; }\n\nbody,\n.main {\n  display: flex;\n  max-width: 100%;\n  flex-direction: column; }\n\n.main {\n  flex-grow: 1;\n  position: relative; }\n", ""]);
...
/***/ "./src/behaviors/cell-dbclick.behavior.ts":
/*!************************************************!*\
  !*** ./src/behaviors/cell-dbclick.behavior.ts ***!
  \************************************************/
/*! no static exports found */
...
function cellDbClickBehavior(app) {
    var editableCell$ = tools_1.delegateFromEvent(app.grid.element, '.cell', 'dblclick').pipe(operators_1.pluck('element'), operators_1.map(function (element) { return app.grid.getCellByElement(element); }));
    var subscription = editableCell$.pipe(operators_1.startWith(null), operators_1.pairwise()).subscribe(function (_a) {
        var previousCell = _a[0], currentCell = _a[1];
        if (previousCell instanceof cell_1.Cell) {
            previousCell.editable = false;
        }
        if (currentCell instanceof cell_1.Cell) {
            currentCell.editable = true;
        }
    });
    // TODO: move editable$ stream to Grid class
    var clickSubscription = rxjs_1.fromEvent(document.body, 'click').pipe(operators_1.withLatestFrom(editableCell$), operators_1.filter(function (_a) {
        var event = _a[0], cell = _a[1];
        return cell && !(event.composedPath().includes(cell.element.nativeElement));
...
exports.cellDbClickBehavior = cellDbClickBehavior;


/***/ }),

/***/ "./src/behaviors/cell-focus.behavior.ts":
/*!**********************************************!*\
  !*** ./src/behaviors/cell-focus.behavior.ts ***!
  \**********************************************/
/*! no static exports found */
...
var tools_1 = __webpack_require__(/*! ../tools */ "./src/tools.ts");
var operators_1 = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
function cellFocusBehavior(app) {
    return tools_1.delegateFromEvent(app.grid.element, '.cell', 'click')
        .pipe(operators_1.pluck('element'))
        .subscribe(function (newCell) {
        app.grid.focused$.next(app.grid.getCellByElement(newCell));
    });
}
exports.cellFocusBehavior = cellFocusBehavior;


/***/ }),

/***/ "./src/behaviors/cell-hover.behavior.ts":
/*!**********************************************!*\
  !*** ./src/behaviors/cell-hover.behavior.ts ***!
  \**********************************************/
/*! no static exports found */
...
var operators_1 = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
var tools_1 = __webpack_require__(/*! ../tools */ "./src/tools.ts");
function cellHoverBehavior(app) {
    return tools_1.delegateFromEvent(document.body, '.cell', 'mousemove')
        .pipe(operators_1.pluck('element'), operators_1.distinctUntilChanged(), operators_1.map(function (cell) {
        if (!(cell instanceof HTMLElement)) {
            return null;
        }
        var _a = cell.dataset, x = _a.x, y = _a.y;
        var xElm = app.grid.element.querySelector(".coll[data-x=\"" + x + "\"]");
        var yElm = app.grid.element.querySelector(".number[data-y=\"" + y + "\"]");
        return { xElm: xElm, yElm: yElm };
    }), operators_1.startWith(null), operators_1.pairwise()).subscribe(function (_a) {
        var previous = _a[0], current = _a[1];
        if (previous) {
            var xElm = previous.xElm, yElm = previous.yElm;
            [xElm, yElm].forEach(function (elm) {
                if (elm)
                    elm.classList.remove('hovered');
            });
        }
        if (current) {
            var xElm = current.xElm, yElm = current.yElm;
            [xElm, yElm].forEach(function (elm) {
                if (elm)
...
exports.cellHoverBehavior = cellHoverBehavior;


/***/ }),

/***/ "./src/behaviors/cell-input.behavior.ts":
/*!**********************************************!*\
  !*** ./src/behaviors/cell-input.behavior.ts ***!
  \**********************************************/
/*! no static exports found */
...
var tools_1 = __webpack_require__(/*! ../tools */ "./src/tools.ts");
var operators_1 = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
function cellInputBehavior(app) {
    return tools_1.delegateFromEvent(app.grid.element, '.cell[contenteditable="true"]', 'input').pipe(operators_1.filter(function (_a) {
        ...
        var input = _a.input, cell = _a.cell;
        cell.input$.next(input);
    });
}
exports.cellInputBehavior = cellInputBehavior;


/***/ }),

/***/ "./src/behaviors/cell-keyboard-navigation.behavior.ts":
/*!************************************************************!*\
  !*** ./src/behaviors/cell-keyboard-navigation.behavior.ts ***!
  \************************************************************/
/*! no static exports found */
...
var knownCodes = new Set([
    tools_1.KEY_CODES.ArrowUp,
    tools_1.KEY_CODES.ArrowDown,
    tools_1.KEY_CODES.ArrowRight,
    tools_1.KEY_CODES.ArrowLeft,
    tools_1.KEY_CODES.Escape,
    tools_1.KEY_CODES.Enter,
    tools_1.KEY_CODES.Backspace,
]);
function cellKeyboardNavigationBehavior(app) {
    return tools_1.delegateFromEvent(app.grid.element, '.cell', 'keydown')
        .pipe(operators_1.map(function (obj) { return obj.event; }), operators_1.withLatestFrom(app.grid.focused$), operators_1.filter(function (_a) {
        var event = _a[0], cell = _a[1];
        return (knownCodes.has(event.which) && cell instanceof cell_1.Cell);
    }))
        .subscribe(function (_a) {
        var event = _a[0], cell = _a[1];
        ...
        switch (event.keyCode) {
            case tools_1.KEY_CODES.ArrowLeft:
                xIndex = bootstrap_1.ALPHABET.indexOf(cell.x);
                if (cell.isEditable || !xIndex) {
                    break;
                }
                focusedCell = app.grid.getCell(bootstrap_1.ALPHABET[xIndex - 1], cell.y);
                app.grid.focused$.next(focusedCell);
                break;
            case tools_1.KEY_CODES.ArrowRight:
                xIndex = bootstrap_1.ALPHABET.indexOf(cell.x);
                if (cell.isEditable || xIndex === bootstrap_1.ALPHABET.length - 1) {
                    break;
                }
                focusedCell = app.grid.getCell(bootstrap_1.ALPHABET[xIndex + 1], cell.y);
                app.grid.focused$.next(focusedCell);
                break;
            case tools_1.KEY_CODES.ArrowUp:
                ...
                app.grid.focused$.next(focusedCell);
                break;
            case tools_1.KEY_CODES.ArrowDown:
                if (cell.isEditable) {
                    break;
                }
                yIndex = parseInt(cell.y);
            ...
            case tools_1.KEY_CODES.Enter:
                ...
                break;
            case tools_1.KEY_CODES.Backspace:
                // if (!cell.isEditable) {
                //   cell.input$.next('');
                // }
                break;
...
exports.cellKeyboardNavigationBehavior = cellKeyboardNavigationBehavior;


/***/ }),

/***/ "./src/behaviors/column-resize.behavior.tsx":
/*!**************************************************!*\
  !*** ./src/behaviors/column-resize.behavior.tsx ***!
  \**************************************************/
/*! no static exports found */
...
var bootstrap_1 = __webpack_require__(/*! ../bootstrap */ "./src/bootstrap.tsx");
var rxjs_1 = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
var animationFrame_1 = __webpack_require__(/*! rxjs/internal/scheduler/animationFrame */ "./node_modules/rxjs/internal/scheduler/animationFrame.js");
var DEFAULT_COLUMNS_TEMPLATE = Array.from({ length: bootstrap_1.ALPHABET.length }, function () { return '100px'; });
function updateColumnsTemplate(app, col, x) {
    var columns_template_value = app.grid.element.style.getPropertyValue('--coll-template');
    var columns_template = columns_template_value.length ? columns_template_value.split(' ') : DEFAULT_COLUMNS_TEMPLATE;
    var index = bootstrap_1.ALPHABET.indexOf(col.element.dataset.x);
    columns_template[index] = x - col.rect.x + "px";
    app.grid.element.style.setProperty('--coll-template', columns_template.join(' '));
}
function getColX(currentPosition, newPosition) {
    return (newPosition - currentPosition > 80) ? newPosition : 80 - (newPosition - currentPosition) + newPosition;
}
function columnResizeBehavior(app) {
    var verticalMarker = jsx_1.default("div", { className: "vertical-resize-marker" });
    app.grid.element.appendChild(verticalMarker);
    var subscription = new rxjs_1.Subscription();
    var down$ = tools_1.delegateFromEvent(document.body, '.coll-resize-marker', 'mousedown').pipe(operators_1.map(function (_a) {
        var element = _a.element;
        return element && element.parentElement;
    }), operators_1.filter(function (element) { return !!element; }), operators_1.map(function (element) { return ({ element: element, rect: element.getBoundingClientRect() }); }));
    var up$ = rxjs_1.fromEvent(document.body, 'mouseup');
    var move$ = rxjs_1.fromEvent(document.body, 'mousemove').pipe(operators_1.map(function (event) { return app.grid.element.scrollLeft + event.clientX; }));
    var updateSubscription = down$.pipe(operators_1.tap(function () { return app.grid.element.classList.add('no-select'); }), operators_1.switchMap(function (col) { return up$.pipe(operators_1.map(function (event) { return ({ col: col, x: event.clientX }); }), operators_1.map(function (_a) {
        var col = _a.col, x = _a.x;
        return ({ col: col, x: getColX(col.rect.x, x) });
    }), operators_1.take(1)); })).subscribe(function (_a) {
        var col = _a.col, x = _a.x;
        verticalMarker.style.transform = 'translateX(-2px)';
        app.grid.element.classList.remove('no-select');
        updateColumnsTemplate(app, col, x);
    });
    var moveSubscription = down$.pipe(operators_1.mergeMap(function (col) { return move$.pipe(operators_1.map(function (x) {
        var scrollLeft = app.grid.element.scrollLeft;
        return getColX(col.rect.x, x - scrollLeft) + scrollLeft;
    }), operators_1.observeOn(animationFrame_1.animationFrame), operators_1.takeUntil(up$)); })).subscribe(function (x) {
...
exports.columnResizeBehavior = columnResizeBehavior;


/***/ }),

/***/ "./src/behaviors/grid-resize.behavior.tsx":
/*!************************************************!*\
  !*** ./src/behaviors/grid-resize.behavior.tsx ***!
  \************************************************/
/*! no static exports found */
...
var animationFrame_1 = __webpack_require__(/*! rxjs/internal/scheduler/animationFrame */ "./node_modules/rxjs/internal/scheduler/animationFrame.js");
var CELL_HEIGHT = 36;
function gridResizeBehavior(app) {
    return rxjs_1.fromEvent(window, 'resize').pipe(operators_1.startWith(''), operators_1.map(function () { return Math.floor(app.grid.element.offsetHeight / CELL_HEIGHT); }), operators_1.distinctUntilChanged(), operators_1.observeOn(animationFrame_1.animationFrame), operators_1.startWith(0), operators_1.pairwise()).subscribe(function (_a) {
...
exports.gridResizeBehavior = gridResizeBehavior;


/***/ }),

/***/ "./src/behaviors/header-input.behavior.ts":
/*!************************************************!*\
  !*** ./src/behaviors/header-input.behavior.ts ***!
  \************************************************/
/*! no static exports found */
...
var cell_1 = __webpack_require__(/*! ../cell */ "./src/cell.ts");
var tools_1 = __webpack_require__(/*! ../tools */ "./src/tools.ts");
function headerInputBehavior(app) {
    // TODO: support ENTER key (move to and focus cell)
    var subscription = new rxjs_1.Subscription();
    var primaryInput = app.header.input;
    // update primary input when cell focus changed
    var focusedSubscription = app.grid.focused$.pipe(operators_1.filter(function (cell) { return cell instanceof cell_1.Cell; }), operators_1.switchMap(function (cell) { return cell.input$; }), operators_1.filter(function (input) { return primaryInput.value !== input; })).subscribe(function (input) {
        primaryInput.value = input;
    });
    subscription.add(focusedSubscription);
    // update cell input when primary input changed
    var inputSubscription = rxjs_1.fromEvent(primaryInput, 'input').pipe(operators_1.withLatestFrom(app.grid.focused$), operators_1.filter(function (_a) {
        var target = _a[0].target, cell = _a[1];
        return cell instanceof cell_1.Cell && cell.input$.value !== target.value;
    })).subscribe(function (_a) {
        var target = _a[0].target, cell = _a[1];
        cell.input$.next(target.value);
    });
    subscription.add(inputSubscription);
    // move focus to grid element on ENTER
    var enterSubscription = rxjs_1.fromEvent(primaryInput, 'keydown').pipe(operators_1.filter(function (event) { return event.which === tools_1.KEY_CODES.Enter; })).subscribe(function (event) {
        event.stopPropagation();
        app.grid.element.focus();
    });
...
exports.headerInputBehavior = headerInputBehavior;
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./cell-focus.behavior */ "./src/behaviors/cell-focus.behavior.ts"));
__export(__webpack_require__(/*! ./cell-hover.behavior */ "./src/behaviors/cell-hover.behavior.ts"));
__export(__webpack_require__(/*! ./cell-dbclick.behavior */ "./src/behaviors/cell-dbclick.behavior.ts"));
__export(__webpack_require__(/*! ./cell-input.behavior */ "./src/behaviors/cell-input.behavior.ts"));
__export(__webpack_require__(/*! ./cell-keyboard-navigation.behavior */ "./src/behaviors/cell-keyboard-navigation.behavior.ts"));
__export(__webpack_require__(/*! ./header-input.behavior */ "./src/behaviors/header-input.behavior.ts"));
__export(__webpack_require__(/*! ./column-resize.behavior */ "./src/behaviors/column-resize.behavior.tsx"));
...
var xAxis = (jsx_1.default("section", { className: "columns" }, exports.ALPHABET.map(function (l) { return (jsx_1.default("span", { className: "coll", "data-x": l },
    jsx_1.default("span", { className: "coll-content" }, l),
    jsx_1.default("span", { className: "coll-resize-marker" }))); })));
function createGrid() {
    return (jsx_1.default("div", { className: "grid", tabindex: "0" },
        jsx_1.default("span", { className: "tl-corner" }),
        xAxis,
        jsx_1.default("section", { className: "numbers" }),
        jsx_1.default("div", { className: "cells" })));
}
function createHeader() {
    return (jsx_1.default("header", { className: "header" },
        jsx_1.default("input", { className: "fx-input", type: "text" }),
        jsx_1.default("img", { className: "fx-icon", alt: "function", src: "assets/function-icon.svg" })));
}
function bootstrapApp() {
    var header = createHeader();
    // TODO: calculate number of rows that fits to screen viewport
    var grid = createGrid();
    var app = (jsx_1.default("main", { class: "main" },
        header,
        grid));
...
(function (InputErrorTypes) {
    InputErrorTypes[InputErrorTypes["CIRCULAR_DEPENDENCIES"] = 0] = "CIRCULAR_DEPENDENCIES";
...
var Cell = /** @class */ (function () {
    function Cell(grid, x, y) {
        ...
        this.output$ = new rxjs_1.BehaviorSubject({ result: '' });
        this.subscription = new rxjs_1.Subscription();
        this.dependencies = [];
        this.isEditable = false;
        this.id = "" + x + y;
        this.element = this.grid.render.getCellElement(this.x, this.y);
        var inputSubscription = this.input$.pipe(operators_1.map(function (value) { return _this.parseInput(value); }), operators_1.switchMap(function (output$) { return output$; })).subscribe(function (output) { return _this.output$.next(output); }, function (error) { return _this.errorRender(error); });
        this.subscription.add(inputSubscription);
        var outputSubscription = this.output$.pipe(operators_1.pairwise(), operators_1.filter(function () { return !_this.isEditable; })).subscribe(function (_a) {
            var previous = _a[0], current = _a[1];
            return _this.outputRender(previous, current);
        }, function (error) { return _this.errorRender(error); });
        this.subscription.add(outputSubscription);
    }
    Object.defineProperty(Cell.prototype, "editable", {
        set: function (state) {
    ...
    Cell.prototype.parseInput = function (input) {
        var _this = this;
        var token = input.trim().toUpperCase().replace(/ +/g, ' ');
        // is cell
        if (grid_1.CELL_ID_PATTERN.test(token)) {
            var x = token[0];
            var y = token.substr(1);
            var cell = this.grid.getCell(x, y);
            // prevent circular dependencies
            if (this.isDependsOnMe(cell)) {
                return rxjs_1.of({ error: true, errorId: InputErrorTypes.CIRCULAR_DEPENDENCIES, result: '#ERROR' });
            }
            this.dependencies = [cell];
            return cell.output$;
        }
        if (this.grid.parser.isFunction(token)) {
            var _a = this.grid.parser.exec(token), dependencies = _a.dependencies, output$ = _a.output$;
            if (dependencies.some(function (cell) { return _this.isDependsOnMe(cell); })) {
                return rxjs_1.of({ error: true, errorId: InputErrorTypes.CIRCULAR_DEPENDENCIES, result: '#ERROR' });
            }
            this.dependencies = dependencies;
            return output$;
        }
        return rxjs_1.of({ result: input });
    };
    Cell.prototype.isDependsOnMe = function (cell) {
        var _this = this;
        ...
        return cell.dependencies.some(function (cell) { return _this.isDependsOnMe(cell); });
    };
    Cell.prototype.outputRender = function (previousValue, currentValue) {
    ...
    Cell.prototype.errorRender = function (error) {
        console.log(error);
    };
...
var CellElement = /** @class */ (function () {
    function CellElement(x, y, container) {
        this.x = x;
        this.y = y;
        this.container = container;
    }
    Object.defineProperty(CellElement.prototype, "nativeElement", {
        get: function () {
    ...
    CellElement.prototype.exec = function (operation) {
        var element = this.nativeElement;
        if (element instanceof HTMLElement) {
            operation(element);
        }
    };
    CellElement.prototype.focus = function () {
        this.exec(function (element) { return element.focus(); });
        return this;
    };
    CellElement.prototype.setText = function (text) {
        this.exec(function (element) { return element.innerText = text; });
        return this;
    };
    CellElement.prototype.setError = function (error) {
    ...
    CellElement.prototype.setEditable = function (isEditable) {
        this.exec(function (element) {
    ...
    CellElement.prototype.addClass = function (className) {
        this.exec(function (element) { return element.classList.add(className); });
        return this;
    };
    CellElement.prototype.removeClass = function (className) {
        this.exec(function (element) { return element.classList.remove(className); });
        return this;
    };
    return CellElement;
}());
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./sum */ "./src/functions/sum.ts"));
__export(__webpack_require__(/*! ./minus */ "./src/functions/minus.ts"));
__export(__webpack_require__(/*! ./max */ "./src/functions/max.ts"));
__export(__webpack_require__(/*! ./now */ "./src/functions/now.ts"));


/***/ }),

/***/ "./src/functions/max.ts":
/*!******************************!*\
  !*** ./src/functions/max.ts ***!
  \******************************/
/*! no static exports found */
...
function max() {
    ...
    var result = Math.max.apply(Math, args.map(function (value) { return parseInt(value, 10); }));
...
var render_1 = __webpack_require__(/*! ./render */ "./src/render.tsx");
exports.CELL_ID_PATTERN = /^([A-Z])([1-9][0-9]*)$/;
var Grid = /** @class */ (function () {
    function Grid(element) {
        this.element = element;
        this.CELLS = new Map();
        this.focused$ = new rxjs_1.BehaviorSubject(null);
        this.parser = new parser_1.Parser(this);
        this.render = new render_1.Render(this);
        this.focused$.pipe(operators_1.pairwise()).subscribe(function (_a) {
            var currentCell = _a[0], newCell = _a[1];
            if (currentCell instanceof cell_1.Cell) {
                currentCell.element.removeClass('focused');
            }
            if (newCell instanceof cell_1.Cell) {
    ...
    Grid.prototype.getCell = function (x, y) {
        ...
        if (!this.CELLS.has(cellId)) {
            this.CELLS.set(cellId, new cell_1.Cell(this, x, y));
        }
        return this.CELLS.get(cellId);
    };
    Grid.prototype.getCellInput = function (x, y) {
        var cellId = "" + x + y;
        return this.CELLS.has(cellId) ? this.CELLS.get(cellId).input$.value : '';
    };
    Grid.prototype.getCellOutput = function (x, y) {
        var cellId = "" + x + y;
        return this.CELLS.has(cellId) ? this.CELLS.get(cellId).output$.value.result : '';
    };
    Grid.prototype.getCellByElement = function (element) {
        if (!(element instanceof HTMLElement)) {
            return null;
        }
        var _a = element.dataset, x = _a.x, y = _a.y;
...
var bootstrap_1 = __webpack_require__(/*! ./bootstrap */ "./src/bootstrap.tsx");
var behaviors_1 = __webpack_require__(/*! ./behaviors */ "./src/behaviors/index.ts");
var functions_1 = __webpack_require__(/*! ./functions */ "./src/functions/index.ts");
var grid_resize_behavior_1 = __webpack_require__(/*! ./behaviors/grid-resize.behavior */ "./src/behaviors/grid-resize.behavior.tsx");
var app = bootstrap_1.bootstrapApp();
// initiate plugins
grid_resize_behavior_1.gridResizeBehavior(app);
behaviors_1.cellFocusBehavior(app);
behaviors_1.cellHoverBehavior(app);
behaviors_1.cellDbClickBehavior(app);
behaviors_1.cellInputBehavior(app);
behaviors_1.cellKeyboardNavigationBehavior(app);
behaviors_1.headerInputBehavior(app);
behaviors_1.columnResizeBehavior(app);
// Register function
app.grid.parser.registerFunction('SUM', functions_1.sum);
app.grid.parser.registerFunction('MINUS', functions_1.minus);
app.grid.parser.registerFunction('MAX', functions_1.max);
app.grid.parser.registerFunction('NOW', functions_1.now);
...
var operators_1 = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
var grid_1 = __webpack_require__(/*! ./grid */ "./src/grid.ts");
var FUNCTION_PATTERN = /^=([A-Z]+)\((.*)\)$/i;
var Parser = /** @class */ (function () {
    function Parser(grid) {
        this.grid = grid;
        this.FUNCTIONS = new Map();
    }
    Parser.prototype.registerFunction = function (name, operator) {
    ...
    Parser.prototype.unregisterFunction = function (name) {
        this.FUNCTIONS.delete(name);
    };
    Parser.prototype.isFunction = function (input) {
        return !!this.getFunction(input);
    };
    Parser.prototype.getFunction = function (input) {
        var match = input.match(FUNCTION_PATTERN);
        if (!match) {
            return null;
        }
        var name = match[1];
        ...
        if (this.FUNCTIONS.has(name)) {
            return { operator: this.FUNCTIONS.get(name), args: args, name: name };
        }
        return null;
    };
    Parser.prototype.exec = function (input) {
        var _this = this;
        var response = { dependencies: [], output$: rxjs_1.of() };
        var functionObject = this.getFunction(input);
        if (!functionObject) {
            response.output$ = rxjs_1.of({ error: true, message: 'function not found' });
            return response;
        }
        var args = functionObject.args.map(function (arg) { return _this.resolveArgument(arg); });
        var input$ = args.reduce(function (acc, arg) {
            var output$ = rxjs_1.of({ result: arg });
            if (arg instanceof cell_1.Cell) {
                response.dependencies.push(arg);
                output$ = arg.output$;
            }
            return acc.concat([output$]);
        }, []);
        response.output$ = rxjs_1.combineLatest.apply(void 0, input$).pipe(operators_1.map(function (args) { return args.map(function (arg) { return arg.result; }); }), operators_1.map(function (args) { return functionObject.operator.apply(functionObject, args); }));
        return response;
    };
    Parser.prototype.resolveArgument = function (argument) {
        var token = argument.trim();
        // is cellId
        var cellMatch = token.match(grid_1.CELL_ID_PATTERN);
        if (cellMatch) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var jsx_1 = __webpack_require__(/*! ./jsx */ "./src/jsx.tsx");
var cellElement_1 = __webpack_require__(/*! ./cellElement */ "./src/cellElement.ts");
var bootstrap_1 = __webpack_require__(/*! ./bootstrap */ "./src/bootstrap.tsx");
var CELL_HEIGHT = 36;
var Render = /** @class */ (function () {
    function Render(gird) {
        this.gird = gird;
        this._scrollIndex = 1;
    }
    Object.defineProperty(Render.prototype, "scrollIndex", {
        get: function () {
    ...
    Render.prototype.getCellElement = function (x, y) {
        return new cellElement_1.CellElement(x, y, this.gird.element);
    };
    // TODO: support overflow content in cell. Extend cell size in edit mode.
    Render.prototype.createCell = function (x, y) {
        var value = this.gird.getCellInput(x, y);
        return jsx_1.default("span", { className: "cell", "data-x": x, "data-y": y }, value);
    };
    Render.prototype.createRows = function (from, to) {
        var rowsFragment = document.createDocumentFragment();
        for (var y = from; y < to; y++) {
            for (var i = 0; i < bootstrap_1.ALPHABET.length; i++) {
                rowsFragment.appendChild(this.createCell(bootstrap_1.ALPHABET[i], y + 1));
            }
        }
        return rowsFragment;
    };
    Render.prototype.createYAxis = function (from, to) {
        var yFragment = document.createDocumentFragment();
        for (var i = from; i < to; i++) {
            yFragment.appendChild(jsx_1.default("span", { className: "number", "data-y": i + 1 }, i + 1));
        }
        return yFragment;
    };
    Render.prototype.addRows = function (from, to) {
    ...
    Render.prototype.removeRows = function (from, to) {
        var selector = Array.from({ length: to - from }, function (elm, i) { return ".cell[data-y=\"" + (i + from + 1) + "\"], .number[data-y=\"" + (i + from + 1) + "\"]"; }).join(', ');
        this.gird.element.querySelectorAll(selector).forEach(function (element) { return element.remove(); });
    };
    return Render;
}());
...
var KEY_CODES;
(function (KEY_CODES) {
    KEY_CODES[KEY_CODES["ArrowDown"] = 40] = "ArrowDown";
    KEY_CODES[KEY_CODES["ArrowRight"] = 39] = "ArrowRight";
    KEY_CODES[KEY_CODES["ArrowUp"] = 38] = "ArrowUp";
    KEY_CODES[KEY_CODES["ArrowLeft"] = 37] = "ArrowLeft";
...
function delegateFromEvent(wrapper, selector, eventName) {
    return rxjs_1.fromEvent(wrapper, eventName).pipe(operators_1.map(function (event) {
        var target = event.target;
        return { event: event, element: target.closest(selector) };
    }));
}
exports.delegateFromEvent = delegateFromEvent;
